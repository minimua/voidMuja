使用反射将Java对象转换为json字符串的工具demo
待优化
```java
package com.ealing.erp;

import com.ealing.erp.bo.FlowVo;
...
class JsonUtils {
        ...
        for (Field field : fields) {
            ...
            try {
                ...
                if(object == null){
                    ...
                    else if(simpleName.equals("Boolean")||simpleName.equals("Byte")||simpleName.equals("Integer")||simpleName.equals("Double")||simpleName.equals("Float")||simpleName.equals("Long")){
    ...
    public static void main(String[] args) throws InstantiationException, IllegalAccessException {
        ...
        flowVo.setId(123L);
        flowVo.setName("test");
        flowVo.setTenantId(1L);
        flowVo.setDeleted((byte)0);
        flowVo.setCreateTime(new Date());
        String jsonString = getJsonString(flowVo);
